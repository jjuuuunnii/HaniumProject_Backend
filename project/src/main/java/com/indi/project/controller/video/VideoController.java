...
public class VideoController {
    ...
    public Result<ResponseEntity<SuccessObject>> saveLikes(@PathVariable Long videoId, @RequestBody LikesDto likesDto){
        likeService.saveLikes(videoId, likesDto);
        return new Result<>(ResponseEntity.ok(new SuccessObject(SuccessCode.LIKE_STATUS_POSTED.isSuccess(), SuccessCode.LIKE_STATUS_POSTED.getCode())));
    }
